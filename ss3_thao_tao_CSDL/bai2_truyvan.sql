create database quanlyBanHangHoa;
use quanlyBanHangHoa;
...
Insert into oderdetail(ProductId,OrderId,quantity) values('1','1','3');
Insert into oderdetail(ProductId,OrderId,quantity) values(1,3,7);
Insert into oderdetail(ProductId,OrderId,quantity) values(1,4,2);
Insert into oderdetail(ProductId,OrderId,quantity) values(2,1,1);
Insert into oderdetail(ProductId,OrderId,quantity) values(3,1,8);
Insert into oderdetail(ProductId,OrderId,quantity) values(2,5,4);
Insert into oderdetail(ProductId,OrderId,quantity) values(2,3,4);
...
use quanlyBanHangHoa;
select C.cName, P.ProductName,Odetail.quantity
from customer C
